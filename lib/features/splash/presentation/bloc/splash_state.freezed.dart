...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SplashInitial value)?  initial,TResult Function( SplashLoading value)?  loading,TResult Function( SplashLoaded value)?  loaded,TResult Function( SplashFailure value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return loaded(_that);case SplashFailure() when failure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SplashInitial value)  initial,required TResult Function( SplashLoading value)  loading,required TResult Function( SplashLoaded value)  loaded,required TResult Function( SplashFailure value)  failure,}){
final _that = this;
switch (_that) {
case SplashInitial():
return initial(_that);case SplashLoading():
return loading(_that);case SplashLoaded():
return loaded(_that);case SplashFailure():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SplashInitial value)?  initial,TResult? Function( SplashLoading value)?  loading,TResult? Function( SplashLoaded value)?  loaded,TResult? Function( SplashFailure value)?  failure,}){
final _that = this;
switch (_that) {
case SplashInitial() when initial != null:
return initial(_that);case SplashLoading() when loading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( SplashScreenEntity data)?  loaded,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SplashInitial() when initial != null:
return initial();case SplashLoading() when loading != null:
return loading();case SplashLoaded() when loaded != null:
return loaded(_that.data);case SplashFailure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( SplashScreenEntity data)  loaded,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case SplashInitial():
return initial();case SplashLoading():
return loading();case SplashLoaded():
return loaded(_that.data);case SplashFailure():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( SplashScreenEntity data)?  loaded,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case SplashInitial() when initial != null:
return initial();case SplashLoading() when loading != null:
return loading();case SplashLoaded() when loaded != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashLoaded&&(identical(other.data, data) || other.data == data));
}
