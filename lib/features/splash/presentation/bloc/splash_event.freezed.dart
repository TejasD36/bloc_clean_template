...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( SplashLoadRequested value)?  load,required TResult orElse(),}){
final _that = this;
switch (_that) {
case SplashLoadRequested() when load != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( SplashLoadRequested value)  load,}){
final _that = this;
switch (_that) {
case SplashLoadRequested():
return load(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( SplashLoadRequested value)?  load,}){
final _that = this;
switch (_that) {
case SplashLoadRequested() when load != null:
return load(_that);case _:
...
class SplashLoadRequested implements SplashEvent {
  const SplashLoadRequested();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashLoadRequested);
}
