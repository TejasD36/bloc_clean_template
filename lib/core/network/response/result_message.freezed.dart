...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResultMessage&&(identical(other.message, message) || other.message == message));
}
...
class _ResultMessage implements ResultMessage {
  ...
  factory _ResultMessage.fromJson(Map<String, dynamic> json) => _$ResultMessageFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$ResultMessageToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ResultMessage&&(identical(other.message, message) || other.message == message));
}
