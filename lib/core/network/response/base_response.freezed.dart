...
mixin _$BaseResponse<T> {
 ...
 bool get status; String get message; T? get data; Pagination? get pagination; ErrorModel? get error;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,message,const DeepCollectionEquality().hash(data),pagination,error);

@override
String toString() {
  return 'BaseResponse<$T>(status: $status, message: $message, data: $data, pagination: $pagination, error: $error)';
}
...
@useResult
$Res call({
 bool status, String message, T? data, Pagination? pagination, ErrorModel? error
});


$PaginationCopyWith<$Res>? get pagination;$ErrorModelCopyWith<$Res>? get error;
...
/// Create a copy of BaseResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? message = null,Object? data = freezed,Object? pagination = freezed,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool status,  String message,  T? data,  Pagination? pagination,  ErrorModel? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BaseResponse() when $default != null:
return $default(_that.status,_that.message,_that.data,_that.pagination,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool status,  String message,  T? data,  Pagination? pagination,  ErrorModel? error)  $default,) {final _that = this;
switch (_that) {
case _BaseResponse():
return $default(_that.status,_that.message,_that.data,_that.pagination,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool status,  String message,  T? data,  Pagination? pagination,  ErrorModel? error)?  $default,) {final _that = this;
switch (_that) {
case _BaseResponse() when $default != null:
return $default(_that.status,_that.message,_that.data,_that.pagination,_that.error);case _:
  return null;
...
class _BaseResponse<T> implements BaseResponse<T> {
  const _BaseResponse({required this.status, required this.message, this.data, this.pagination, this.error});
...
@override $PaginationCopyWith<$Res>? get pagination;@override $ErrorModelCopyWith<$Res>? get error;
...
/// Create a copy of BaseResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? message = null,Object? data = freezed,Object? pagination = freezed,Object? error = freezed,}) {
