...
BaseResponse<dynamic> _parseInBackground(Map<String, dynamic> json) {
...
class Parser {
  ...
  static Future<Either<AppException, BaseResponse<T>>> parseBaseResponse<T>(
    ...
    try {
      ...
      if (_shouldUseIsolate(json)) {
        base = await compute(_parseInBackground, json);
      } else {
      ...
      final T? parsedData = data == null ? null : mapper.fromJson(data);
  ...
  static bool _shouldUseIsolate(Map<String, dynamic> json) {
    try {
