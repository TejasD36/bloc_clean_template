...
import '../../domain/enum/notification_channel_type.dart';
import '../../domain/strategies/notification_rate_limit_strategy.dart';
import '../../domain/strategies/notification_strategy.dart';
import '../adapters/awesome_notifications_adapter.dart';
import '../handlers/awesome_notification_event_handler.dart';

class AwesomeNotificationStrategy implements NotificationStrategy {
  AwesomeNotificationStrategy({
    required this.rateLimitStrategy,
    required this.adapter,
    required this.channelRegistry,
  });
  ...
  Future<void> showChatMessage({
    ...
    await adapter.create(
      NotificationContent(
        ...
        payload: route != null
            ? {'route': route, 'messageId': messageId}
            : null,
        notificationLayout: chatType == ChatType.group
